    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-50 p-3.5 sm:p-4 rounded-full bg-gradient-to-tr from-brand-600 to-amber-500 text-white shadow-2xl hover:scale-105 transition-all flex items-center space-x-2 border-2 border-white/30 group animate-bounce"
      ...
      {isOpen && (
        <div className="fixed bottom-16 right-3 sm:bottom-6 sm:right-6 z-50 w-[92vw] sm:w-96 h-[500px] sm:h-[540px] bg-white rounded-3xl shadow-2xl border border-orange-200 flex flex-col overflow-hidden animate-fadeIn">
          
          {/* Header */}
          <div className="bg-slate-900 text-white p-4 flex items-center justify-between border-b border-slate-800">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-brand-600 to-amber-500 flex items-center justify-center text-white font-black shadow-md border border-white/20">
                  ...
                  {quickPrompts.map(qp => {
                    ...
                    return (
                      <button
                        ...
                        className="text-left text-xs bg-white hover:bg-orange-50 text-slate-700 font-medium p-2.5 rounded-xl border border-slate-200 hover:border-orange-300 transition-all flex items-center space-x-2 shadow-xs group"
                      >
