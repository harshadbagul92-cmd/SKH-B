...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#0A192F] text-slate-100 min-h-screen flex flex-col justify-between border-r border-slate-700 shrink-0 sticky top-0 h-screen z-30 select-none shadow-xl">
      
      {/* Top: Branding Header */}
      <div>
        <div className="p-5 border-b border-slate-700/80 flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-1.5">
              ...
              <span className="text-[9px] uppercase font-black bg-gold-500 text-navy-950 px-1.5 py-0.2 rounded font-mono">
                EdTech
              </span>
            </div>
        ...
        <div className="px-4 py-3 border-b border-slate-700 bg-slate-900 flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            <div className="w-8 h-8 rounded-lg bg-brand-600 text-white font-black text-xs flex items-center justify-center border border-brand-400">
        ...
        {/* Navigation Menu Links with Sharp Legibility */}
        <nav className="p-3 space-y-1.5">
          <div className="px-3 pt-2 pb-1 text-[10px] uppercase tracking-wider font-black text-slate-400">
            Main Menu
          </div>
