...
export default function LanguageSelectView() {
  ...
  return (
    <div className="min-h-screen bg-[#0A192F] text-white flex flex-col justify-between p-4 sm:p-8 relative overflow-hidden font-sans selection:bg-gold-500 selection:text-navy-950">
