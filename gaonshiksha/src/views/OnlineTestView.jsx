        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="bg-white rounded-3xl border border-slate-300 shadow-xl overflow-hidden">
            ...
            <div className={`p-6 sm:p-8 text-white text-center space-y-3 ${
              savedResult.passed ? 'bg-[#0097A7]' : 'bg-[#0F172A]'
            }`}>
              <div className="w-16 h-16 mx-auto rounded-2xl bg-white text-[#0097A7] flex items-center justify-center text-3xl font-black shadow-lg border-2 border-gold-500">
                {savedResult.passed ? '🏆' : '📋'}
              </div>
